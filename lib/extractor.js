...
Extractor.prototype.getMetatagsFromHtml = function(html) {
  ...
  var metadataObj = _.reduce(metadataObjects, _.extend);
  return metadataObj;
};
...
Extractor.prototype.getMetadataFromHtml = function(url, html) {
  var metatags = this.getMetatagsFromHtml(html);
  var attributes = this.getCommonAttributesFromMetatags(metatags);
  var metadata = _.extend({}, {url: url}, attributes);
  return metadata;
};
